...
|  Start Time  |  Start time of the selection interval. This field supports [End Time](/docs/end-time-syntax.md) syntax, for example 'previous_day'. If Start Time is not defined, it is set to End Time minus Selection Interval.  |
|  End Time  |  End time of the selection interval. This field supports [End Time](/docs/end-time-syntax.md) syntax, for example 'next_day'. If End Time is not defined, it is set to Start Time plus Selection Interval. If Start Time is not defined, End Time is set to current time.  |
