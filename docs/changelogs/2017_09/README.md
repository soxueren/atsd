...
| 3918 | api-rest        | Bug     | Removed the `last` parameter in [series](/docs/api/data/series/query.md) queries. Use [`limit=1`](/docs/api/data/series/query.md#control-filter-fields) instead.                                            |
