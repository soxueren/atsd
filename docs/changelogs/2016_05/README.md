...
In this issue, we took a look at optimizing [partitioning queries](/docs/api/sql#partitioning), leveraging the fact that we can narrow the start and end date for a scan based on the last times in the Last
