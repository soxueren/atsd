...
| startDate | string | [**Required**] ISO 8601 date or [endtime](/docs/end-time-syntax.md) keyword. <br>Delete records updated at or after the specified time. |
| endDate | string | [**Required**] ISO 8601 date or [endtime](/docs/end-time-syntax.md) keyword.<br>Delete records updated before the specified time. |
