...
| severities  | array | Array of [severity names](/docs/api/data/severity.md)   |
| minSeverity |  string   | Minimal severity [name](/docs/api/data/severity.md) filter.  |
...
| severity  | string | [Severity](/docs/api/data/severity.md) name.  |
