...
See the [collectd plugin installation](https://github.com/axibase/axibase-collector/blob/master/docs/jobs/examples/vmware/README.md) instructions for technical details.
