...
Copy `atsd-hbase.17206.jar` to the HDFS `hbase.dynamic.jars.dir` directory.
...
curl -O https://axibase.com/public/atsd-125-migration/atsd-hbase.17206.jar
hadoop fs -put -f atsd-hbase.17206.jar /hbase/lib/atsd-hbase.jar
