...
Copy `atsd-hbase.17292.jar` to the HDFS `hbase.dynamic.jars.dir` directory.
...
curl -O https://axibase.com/public/atsd-125-migration/atsd-hbase.17292.jar
hadoop fs -put -f atsd-hbase.17292.jar /hbase/lib/atsd-hbase.jar
...
curl -o /opt/atsd/atsd/bin/atsd.17292.jar https://axibase.com/public/atsd-125-migration/atsd.17292.jar
