...
| 4202 | csv | Bug | Consolidate error log events when parsing CSV files for simplied troubleshooting. |
...
| 4182 | sql | Bug |Fix parsing error when [`CAST`](https://github.com/axibase/atsd/tree/master/api/sql/#cast) function was used within [`ISNULL`](https://github.com/axibase/atsd/blob/master/api/sql/README.md/#isnull) function with a string argument: `CAST(ISNULL(LOOKUP('tab-1', entity), '0') AS NUMBER)`.|
